...
file_name = input("Enter the file name (encrypted text): ")
...
try:
    ...
    if choice == "yes":
        ...
        output_file = "decrypted_result.txt"
        print(f"File automatically created: {output_file}")

    with open(output_file, "w") as output:
        output.write(result)

    print("Decrypted result successfully saved!")
